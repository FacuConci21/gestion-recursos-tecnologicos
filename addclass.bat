...
SET "ENTITIES_PACKAGE_DIR=%MAIN_SOURCE_JAVA_DIR%\entities"
SET "REPOSITORIES_PACKAGE_DIR=%MAIN_SOURCE_JAVA_DIR%\crud"
...
echo %CLASS_PACKAGE%.entities; >> ./%ENTITIES_PACKAGE_DIR%\%CLASS_NAME%.java
...
echo %CLASS_PACKAGE%.crud; >> ./%REPOSITORIES_PACKAGE_DIR%/%CLASS_REPOSITORY%.java
